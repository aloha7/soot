...
public class GpxGpsLocationGenerator extends SimpleGpsLocationGenerator {
	...
	public GpxGpsLocationGenerator() {
		super(1);
	...
	private void initFromGpx(String gpxFilename) {
		try {
			BufferedReader br = new BufferedReader(new FileReader(gpxFilename));			
			String str = null;			
