...
public class TourApp_49 implements context.arch.handler.Handler
{
    ...
    private static context.apps.Tour.DemoInterests demoInterests;
    ...
    public TourApp_49( java.lang.String userid, java.lang.String configFile, java.lang.String demoFile )
    {
        this( DEFAULT_PORT, userid, configFile, demoFile );
    }

    public TourApp_49( int localport, java.lang.String userid, java.lang.String configFile, java.lang.String demoFile )
    {
        try {
            ...
            System.out.println( "TourApp_49 MalformedURL: " + mue );
        } catch ( context.arch.comm.language.DecodeException de ) {
            System.out.println( "TourApp_49 Decode: " + de );
        }
    }
    ...
    {
        if (argv.length == 3) {
            System.out.println( "Attempting to create a TourApp_49 on " + DEFAULT_PORT + " for " + argv[0] );
            context.apps.Tour.mutants.TourApp_49 ta = new context.apps.Tour.mutants.TourApp_49( argv[0], argv[1], argv[2] );
        } else {
            if (argv.length == 4) {
                System.out.println( "Attempting to create a TourApp_49 on " + argv[1] + " for " + argv[0] );
                context.apps.Tour.mutants.TourApp_49 ta = new context.apps.Tour.mutants.TourApp_49( Integer.parseInt( argv[1] ), argv[0], argv[2], argv[3] );
            } else {
                System.out.println( "USAGE: java TourApp_49 <userid> [port] <config file> <demo info file>" );
            }
        }
    }
