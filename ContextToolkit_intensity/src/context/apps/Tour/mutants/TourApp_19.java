...
public class TourApp_19 implements context.arch.handler.Handler
{
    ...
    public TourApp_19( java.lang.String userid, java.lang.String configFile, java.lang.String demoFile )
    {
        this( DEFAULT_PORT, userid, configFile, demoFile );
    }

    public TourApp_19( int localport, java.lang.String userid, java.lang.String configFile, java.lang.String demoFile )
    {
        try {
            ...
            if (servers != null) {
                for (java.util.Enumeration e = servers.getEnumeration(); e.hasMoreElements();) {
                    ...
                    if (serverObj.getId().indexOf( userid ) != -1) {
                        ...
                        int serverPort = Integer.parseInt( serverObj.getType() );
            ...
            System.out.println( "TourApp_19 MalformedURL: " + mue );
        } catch ( context.arch.comm.language.DecodeException de ) {
            System.out.println( "TourApp_19 Decode: " + de );
        }
    }
    ...
    {
        if (argv.length == 3) {
            System.out.println( "Attempting to create a TourApp_19 on " + DEFAULT_PORT + " for " + argv[0] );
            context.apps.Tour.mutants.TourApp_19 ta = new context.apps.Tour.mutants.TourApp_19( argv[0], argv[1], argv[2] );
        } else {
            if (argv.length == 4) {
                System.out.println( "Attempting to create a TourApp_19 on " + argv[1] + " for " + argv[0] );
                context.apps.Tour.mutants.TourApp_19 ta = new context.apps.Tour.mutants.TourApp_19( Integer.parseInt( argv[1] ), argv[0], argv[2], argv[3] );
            } else {
                System.out.println( "USAGE: java TourApp_19 <userid> [port] <config file> <demo info file>" );
            }
        }
    }
