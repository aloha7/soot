...
public class TourApp_122 implements context.arch.handler.Handler
{
    ...
    public TourApp_122( java.lang.String userid, java.lang.String configFile, java.lang.String demoFile )
    {
        this( DEFAULT_PORT, userid, configFile, demoFile );
    }

    public TourApp_122( int localport, java.lang.String userid, java.lang.String configFile, java.lang.String demoFile )
    {
        try {
    ...
    {
        if (argv.length == 3) {
            System.out.println( "Attempting to create a TourApp_122 on " + DEFAULT_PORT + " for " + argv[0] );
            context.apps.Tour.mutants.TourApp_122 ta = new context.apps.Tour.mutants.TourApp_122( argv[0], argv[1], argv[2] );
        } else {
            if (argv.length == 4) {
                System.out.println( "Attempting to create a TourApp_122 on " + argv[1] + " for " + argv[0] );
                context.apps.Tour.mutants.TourApp_122 ta = new context.apps.Tour.mutants.TourApp_122( Integer.parseInt( argv[1] ), argv[0], argv[2], argv[3] );
            } else {
                System.out.println( "USAGE: java TourApp_122 <userid> [port] <config file> <demo info file>" );
            }
        }
    }
