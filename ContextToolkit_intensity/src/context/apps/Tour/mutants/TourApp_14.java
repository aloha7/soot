...
public class TourApp_14 implements context.arch.handler.Handler
{
    ...
    public TourApp_14( java.lang.String userid, java.lang.String configFile, java.lang.String demoFile )
    {
        this( DEFAULT_PORT, userid, configFile, demoFile );
    }

    public TourApp_14( int localport, java.lang.String userid, java.lang.String configFile, java.lang.String demoFile )
    {
        try {
            ...
            if (servers != null) {
                for (java.util.Enumeration e = servers.getEnumeration(); e.hasMoreElements();) {
                    ...
                    if (serverObj.getId().indexOf( userid ) != -1) {
                        java.lang.String serverId = serverObj.getHost();
            ...
            System.out.println( "TourApp_14 MalformedURL: " + mue );
        } catch ( context.arch.comm.language.DecodeException de ) {
            System.out.println( "TourApp_14 Decode: " + de );
        }
    }
    ...
    {
        if (argv.length == 3) {
            System.out.println( "Attempting to create a TourApp_14 on " + DEFAULT_PORT + " for " + argv[0] );
            context.apps.Tour.mutants.TourApp_14 ta = new context.apps.Tour.mutants.TourApp_14( argv[0], argv[1], argv[2] );
        } else {
            if (argv.length == 4) {
                System.out.println( "Attempting to create a TourApp_14 on " + argv[1] + " for " + argv[0] );
                context.apps.Tour.mutants.TourApp_14 ta = new context.apps.Tour.mutants.TourApp_14( Integer.parseInt( argv[1] ), argv[0], argv[2], argv[3] );
            } else {
                System.out.println( "USAGE: java TourApp_14 <userid> [port] <config file> <demo info file>" );
            }
        }
    }
