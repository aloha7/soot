...
public class TourApp_57 implements context.arch.handler.Handler
{
    ...
    private static java.lang.String intHost;
    ...
    public TourApp_57( java.lang.String userid, java.lang.String configFile, java.lang.String demoFile )
    {
        this( DEFAULT_PORT, userid, configFile, demoFile );
    }

    public TourApp_57( int localport, java.lang.String userid, java.lang.String configFile, java.lang.String demoFile )
    {
        try {
            ...
            System.out.println( "TourApp_57 MalformedURL: " + mue );
        } catch ( context.arch.comm.language.DecodeException de ) {
            System.out.println( "TourApp_57 Decode: " + de );
        }
    }
    ...
    {
        if (argv.length == 3) {
            System.out.println( "Attempting to create a TourApp_57 on " + DEFAULT_PORT + " for " + argv[0] );
            context.apps.Tour.mutants.TourApp_57 ta = new context.apps.Tour.mutants.TourApp_57( argv[0], argv[1], argv[2] );
        } else {
            if (argv.length == 4) {
                System.out.println( "Attempting to create a TourApp_57 on " + argv[1] + " for " + argv[0] );
                context.apps.Tour.mutants.TourApp_57 ta = new context.apps.Tour.mutants.TourApp_57( Integer.parseInt( argv[1] ), argv[0], argv[2], argv[3] );
            } else {
                System.out.println( "USAGE: java TourApp_57 <userid> [port] <config file> <demo info file>" );
            }
        }
    }
