...
public class TourApp_5 implements context.arch.handler.Handler
{
    ...
    public TourApp_5( java.lang.String userid, java.lang.String configFile, java.lang.String demoFile )
    {
        this( DEFAULT_PORT, userid, configFile, demoFile );
    }

    public TourApp_5( int localport, java.lang.String userid, java.lang.String configFile, java.lang.String demoFile )
    {
        try {
            ...
            context.arch.util.ConfigObjects servers = config.getOtherConfigurations();
            if (servers != null) {
            ...
            System.out.println( "TourApp_5 MalformedURL: " + mue );
        } catch ( context.arch.comm.language.DecodeException de ) {
            System.out.println( "TourApp_5 Decode: " + de );
        }
    }
    ...
    {
        if (argv.length == 3) {
            System.out.println( "Attempting to create a TourApp_5 on " + DEFAULT_PORT + " for " + argv[0] );
            context.apps.Tour.mutants.TourApp_5 ta = new context.apps.Tour.mutants.TourApp_5( argv[0], argv[1], argv[2] );
        } else {
            if (argv.length == 4) {
                System.out.println( "Attempting to create a TourApp_5 on " + argv[1] + " for " + argv[0] );
                context.apps.Tour.mutants.TourApp_5 ta = new context.apps.Tour.mutants.TourApp_5( Integer.parseInt( argv[1] ), argv[0], argv[2], argv[3] );
            } else {
                System.out.println( "USAGE: java TourApp_5 <userid> [port] <config file> <demo info file>" );
            }
        }
    }
