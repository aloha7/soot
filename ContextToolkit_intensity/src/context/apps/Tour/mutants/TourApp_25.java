...
public class TourApp_25 implements context.arch.handler.Handler
{
    ...
    public TourApp_25( java.lang.String userid, java.lang.String configFile, java.lang.String demoFile )
    {
        this( DEFAULT_PORT, userid, configFile, demoFile );
    }

    public TourApp_25( int localport, java.lang.String userid, java.lang.String configFile, java.lang.String demoFile )
    {
        try {
            ...
            System.out.println( "TourApp_25 MalformedURL: " + mue );
        } catch ( context.arch.comm.language.DecodeException de ) {
            System.out.println( "TourApp_25 Decode: " + de );
        }
    }
                ...
                if (callback.equals( SUBSCRIBER_ID + Constants.SPACER + WTourDemo.INTEREST )) {
                    ...
                    if (callback.equals( SUBSCRIBER_ID + Constants.SPACER + WTourEnd.END )) {
                        ...
                        for (int i = 0; i < demoVisits.numDemoVisits(); i++) {
                            ...
                            message.append( "Your level of interest in this demo was: " + dv.getDemoerUrl() + ".\n" );
    ...
    {
        if (argv.length == 3) {
            System.out.println( "Attempting to create a TourApp_25 on " + DEFAULT_PORT + " for " + argv[0] );
            context.apps.Tour.mutants.TourApp_25 ta = new context.apps.Tour.mutants.TourApp_25( argv[0], argv[1], argv[2] );
        } else {
            if (argv.length == 4) {
                System.out.println( "Attempting to create a TourApp_25 on " + argv[1] + " for " + argv[0] );
                context.apps.Tour.mutants.TourApp_25 ta = new context.apps.Tour.mutants.TourApp_25( Integer.parseInt( argv[1] ), argv[0], argv[2], argv[3] );
            } else {
                System.out.println( "USAGE: java TourApp_25 <userid> [port] <config file> <demo info file>" );
            }
        }
    }
