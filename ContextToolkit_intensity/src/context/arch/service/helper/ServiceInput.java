...
public class ServiceInput {
  ...
  private AttributeNameValues input;
  private String host;
  private String port;
  private String id;
   ...
   */
  public ServiceInput(String service, String function, AttributeNameValues input) {
   ...
   */
  public ServiceInput(String serviceId,String service, String function, AttributeNameValues input, String host, 
  ...
  public ServiceInput(DataObject data) {
	...
	/*//2008.7.2: this is the modified one
	DataObject idObj = data.getDataObject("InvokerID");
	if (idObj != null) {
	...
	*/
    ...
    input = new AttributeNameValues(serv);
   ...
   */
  public AttributeNameValues getInput() {
    return input;
  }
