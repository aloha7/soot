...
public class HTTPServerSocket extends TCPServerSocket implements CommunicationsServer {
  ...
  public void handleIncomingRequest(Socket dataSocket) {
    ...
    try {
 //  	RequestData data = this.stripRequestProtocol(dataSocket); 
//System.out.println(this.getClass().getName() + ":\r\n" + "Type:" + data.getType() + "\r\n" + "Line:" + data.getLine() /*+ "Data:" + data.getData().toString()*/);    	
      dataSocket.close();
  ...
  public String addReplyProtocol(String data) throws ProtocolException {
    ...
    sb.append(data);
//System.out.println(this.getClass().getName()+""+sb);
    return (sb.toString());
  }
  ...
  public RequestData stripRequestProtocol(Socket data) throws ProtocolException {
    ...
    try {
      ...
      if (method.equals("GET")) { 
        ...
        //2008/7/5: delete extra characters in the file
        if(file.startsWith("/"))
...
// System.out.println(addReplyProtocols("HelloWorld"));
  }
