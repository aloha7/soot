...
public class TestCFG2_139 extends Application {
// Fault notes: 
...
//	private int mode = MODE_MIX;
	...
	private boolean funcLocWalkAdjVeloOk(Context ctx1, Context ctx2) { // boolean function 2
		...
		boolean result = false;
		double vmin = (VELOCITY * ((double) t / 1000) - /*2 **/ ERR) / ((double) t / 1000); // Seeded fault
		double vmax = (VELOCITY * ((double) t / 1000) + /*2 **/ ERR) / ((double) t / 1000); // Seeded fault
