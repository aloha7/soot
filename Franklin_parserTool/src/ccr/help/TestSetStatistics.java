...
public class TestSetStatistics {
	...
	/**2010-02-01: load reduced test sets generated by ILP model
	 * 
	 * @param testSetDir
	 * @param containHeader
	 * @param pattern
	 * @return
	 */
	public static ArrayList<TestSet> loadReducedTestSet_offline(String testSetDir, boolean containHeader, String pattern){
		
		ArrayList<TestSet> testSets = new ArrayList<TestSet>();
		ArrayList<ILPOutput> outputs = loadILPOutput_offline(testSetDir, containHeader, pattern);
	...
	/**2010-02-01: load ILPOutput generated by ILP model
	 * 
	 * @param testSetDir
	 * @param containHeader
	 * @param pattern
	 * @return
	 */
	public static ArrayList<ILPOutput> loadILPOutput_offline(String testSetDir, boolean containHeader, String pattern){
		ArrayList<ILPOutput> outputs = new ArrayList<ILPOutput>();		
		File dir = new File(testSetDir);
		if(dir.exists()){
			
			File[] files = new File(testSetDir).listFiles();
			for (File file : files) {
			...
			System.out.println("[TestSetStatistics.loadReducedTestSet_offline]The directory:" + testSetDir+ "doest not exist!");
		}
		return outputs;
	}
