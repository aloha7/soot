...
// Unit:    Class benchmarks.detinfer.pj.edu.rit.hyb.fractal.MandelbrotSetHyb
//
...
import benchmarks.detinfer.pj.edu.rit.pj.PJProperties;
 ...
 * -Dpj.schedule=<I>schedule</I> ] benchmarks.detinfer.pj.edu.rit.hyb.fractal.MandelbrotSetHyb
...
// Hidden operations.
	...
	private static void usage()
		{
		System.err.println ("Usage: java -Dpj.np=<Kp> -Dpj.nt=<Kt> [-Dpj.schedule=<schedule>] benchmarks.detinfer.pj.edu.rit.hyb.fractal.MandelbrotSetHyb <width> <height> <xcenter> <ycenter> <resolution> <maxiter> <gamma> <filename>");
