...
// Package: benchmarks.detinfer.pj.edu.rit.hyb.fractal
// Unit:    Class benchmarks.detinfer.pj.edu.rit.hyb.fractal.MandelbrotSetHyb2
//
...
import benchmarks.detinfer.pj.edu.rit.color.HSB;

import benchmarks.detinfer.pj.edu.rit.image.PJGColorImage;
import benchmarks.detinfer.pj.edu.rit.image.PJGImage;

import benchmarks.detinfer.pj.edu.rit.io.Files;

import benchmarks.detinfer.pj.edu.rit.mp.IntegerBuf;
import benchmarks.detinfer.pj.edu.rit.mp.ObjectBuf;

import benchmarks.detinfer.pj.edu.rit.mp.buf.ObjectItemBuf;

import benchmarks.detinfer.pj.edu.rit.pj.Comm;
import benchmarks.detinfer.pj.edu.rit.pj.CommStatus;
import benchmarks.detinfer.pj.edu.rit.pj.IntegerForLoop;
import benchmarks.detinfer.pj.edu.rit.pj.IntegerSchedule;
import benchmarks.detinfer.pj.edu.rit.pj.ParallelRegion;
import benchmarks.detinfer.pj.edu.rit.pj.ParallelSection;
import benchmarks.detinfer.pj.edu.rit.pj.ParallelTeam;
 ...
 * <TT>pj.schedule</TT> property, see class {@linkplain benchmarks.detinfer.pj.edu.rit.pj.PJProperties
 * PJProperties}.
 * <P>
 ...
 * benchmarks.detinfer.pj.edu.rit.pj.IntegerSchedule IntegerSchedule}.
 * <P>
 * Usage: java -Dpj.np=<I>Kp</I> -Dpj.nt=<I>Kt</I> [
 * -Dpj.schedule=<I>procschedule</I> ] benchmarks.detinfer.pj.edu.rit.hyb.fractal.MandelbrotSetHyb2
...
// Hidden operations.
	...
	private static void usage()
		{
		System.err.println ("Usage: java -Dpj.np=<Kp> -Dpj.nt=<Kt> [-Dpj.schedule=<procschedule>] benchmarks.detinfer.pj.edu.rit.hyb.fractal.MandelbrotSetHyb2 <width> <height> <xcenter> <ycenter> <resolution> <maxiter> <gamma> <filename> [<thrschedule>]");
