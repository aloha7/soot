...
//
// File:    Drawing.java
// Package: benchmarks.detinfer.pj.edu.rit.draw
// Unit:    Class benchmarks.detinfer.pj.edu.rit.draw.Drawing
//
...
import benchmarks.detinfer.pj.edu.rit.draw.item.ColorFill;
import benchmarks.detinfer.pj.edu.rit.draw.item.DrawingItem;
import benchmarks.detinfer.pj.edu.rit.draw.item.Group;
import benchmarks.detinfer.pj.edu.rit.draw.item.Point;
import benchmarks.detinfer.pj.edu.rit.draw.item.Size;
...
// Exported operations.
	...
	/**
	 * Returns a {@linkplain benchmarks.detinfer.pj.edu.rit.draw.item.Group Group} consisting of the
