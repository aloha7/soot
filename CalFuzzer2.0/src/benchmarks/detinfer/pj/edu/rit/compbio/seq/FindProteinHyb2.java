...
// Package: benchmarks.detinfer.pj.edu.rit.compbio.seq
// Unit:    Class benchmarks.detinfer.pj.edu.rit.compbio.seq.FindProteinHyb2
//
...
import benchmarks.detinfer.pj.edu.rit.pj.LongForLoop;
import benchmarks.detinfer.pj.edu.rit.pj.LongSchedule;
...
import benchmarks.detinfer.pj.edu.rit.util.LongRange;
 ...
 * -Dpj.schedule=<I>procschedule</I> ] benchmarks.detinfer.pj.edu.rit.compbio.seq.FindProteinHyb2
...
// Hidden operations.
	...
	private static void usage()
		{
		System.err.println ("Usage: java -Dpj.np=<Kp> -Dpj.nt=<Kt> [-Dpj.schedule=<procschedule>] benchmarks.detinfer.pj.edu.rit.compbio.seq.FindProteinHyb2 <queryfile> <databasefile> <indexfile> [<thrschedule> [<expect>]]");
