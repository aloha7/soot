...
// Package: benchmarks.detinfer.pj.edu.rit.compbio.phyl
// Unit:    Class benchmarks.detinfer.pj.edu.rit.compbio.phyl.PhylogenyParsBnbHyb
//
...
import benchmarks.detinfer.pj.edu.rit.mp.buf.IntegerItemBuf;
...
import benchmarks.detinfer.pj.edu.rit.pj.replica.ReplicatedInteger;
 ...
 * -Dpj.schedule=<I>schedule</I> ] benchmarks.detinfer.pj.edu.rit.compbio.phyl.PhylogenyParsBnbHyb
...
// Main program.
	...
	public static void main
		...
		if (rank == 0)
			...
			Results.report
				(/*directory      */ outdir,
				 /*programName    */ "benchmarks.detinfer.pj.edu.rit.compbio.phyl.PhylogenyParsBnbHyb",
...
//		}
	...
	private static void usage()
		{
		System.err.println ("Usage: java [-Dpj.np=<Kp>] [-Dpj.nt=<Kt>] [-Dpj.schedule=<schedule>] benchmarks.detinfer.pj.edu.rit.compbio.phyl.PhylogenyParsBnbHyb <infile> <outdir> [<N> [<T>]]");
