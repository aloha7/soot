...
// Unit:    Class benchmarks.detinfer.pj.edu.rit.compbio.seq.FindProteinHyb
//
 ...
 * -Dpj.schedule=<I>schedule</I> ] benchmarks.detinfer.pj.edu.rit.compbio.seq.FindProteinHyb
...
// Hidden operations.
	...
	private static void usage()
		{
		System.err.println ("Usage: java -Dpj.np=<Kp> -Dpj.nt=<Kt> [-Dpj.schedule=<schedule>] benchmarks.detinfer.pj.edu.rit.compbio.seq.FindProteinHyb <queryfile> <databasefile> <indexfile> [<expect>]");
