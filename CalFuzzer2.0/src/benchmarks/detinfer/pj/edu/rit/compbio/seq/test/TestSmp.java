...
//
// File:    TestSmp.java
// Package: benchmarks.detinfer.pj.edu.rit.compbio.seq.test
// Unit:    Class benchmarks.detinfer.pj.edu.rit.compbio.seq.test.TestSmp
//
...
import benchmarks.detinfer.pj.edu.rit.compbio.seq.Alignment;
import benchmarks.detinfer.pj.edu.rit.compbio.seq.AlignmentPrinter;
import benchmarks.detinfer.pj.edu.rit.compbio.seq.AlignmentStats;
import benchmarks.detinfer.pj.edu.rit.compbio.seq.DefaultAlignmentStats;
import benchmarks.detinfer.pj.edu.rit.compbio.seq.ProteinLocalAlignment;
import benchmarks.detinfer.pj.edu.rit.compbio.seq.ProteinLocalAlignmentSmp;
import benchmarks.detinfer.pj.edu.rit.compbio.seq.ProteinSequence;
 ...
 * benchmarks.detinfer.pj.edu.rit.compbio.seq.ProteinSequence} and {@linkplain
 * benchmarks.detinfer.pj.edu.rit.compbio.seq.ProteinLocalAlignmentSmp}. The program reads in a query
 * sequence and a subject sequence, aligns them in a parallel thread team, and
 * prints the alignment.
 * <P>
 * Usage: java -Dpj.nt=<I>K</I> benchmarks.detinfer.pj.edu.rit.compbio.seq.test.TestSmp
...
// Hidden operations.
	...
	private static void usage()
		{
		System.err.println ("Usage: java -Dpj.nt=<K> benchmarks.detinfer.pj.edu.rit.compbio.seq.test.TestSmp <queryfile> <subjectfile>");
