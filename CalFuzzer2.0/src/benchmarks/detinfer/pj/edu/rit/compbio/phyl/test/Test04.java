...
//
// File:    Test04.java
// Package: benchmarks.detinfer.pj.edu.rit.compbio.phyl.test
// Unit:    Class benchmarks.detinfer.pj.edu.rit.compbio.phyl.test.Test04
//
...
import benchmarks.detinfer.pj.edu.rit.compbio.phyl.DnaSequence;
import benchmarks.detinfer.pj.edu.rit.compbio.phyl.DnaSequenceList;
import benchmarks.detinfer.pj.edu.rit.compbio.phyl.DnaSequenceTree;
import benchmarks.detinfer.pj.edu.rit.compbio.phyl.FitchParsimony;
import benchmarks.detinfer.pj.edu.rit.compbio.phyl.JukesCantorDistance;
import benchmarks.detinfer.pj.edu.rit.compbio.phyl.TreeDrawing;
import benchmarks.detinfer.pj.edu.rit.compbio.phyl.Upgma;

import benchmarks.detinfer.pj.edu.rit.draw.Drawing;

import java.io.File;

/**
 * Class Test04 is a unit test program for classes {@linkplain
 * benchmarks.detinfer.pj.edu.rit.compbio.phyl.DnaSequenceList}, {@linkplain
 * benchmarks.detinfer.pj.edu.rit.compbio.phyl.DnaSequenceTree}, {@linkplain
 * benchmarks.detinfer.pj.edu.rit.compbio.phyl.FitchParsimony}, and {@linkplain
 * benchmarks.detinfer.pj.edu.rit.compbio.phyl.Upgma}. The program:
 * <OL TYPE=1>
 * <LI>
 ...
 * benchmarks.detinfer.pj.edu.rit.draw.Drawing} object.
 * </OL>
 * <P>
 * The {@linkplain View} program can be used to view the drawing file and
 * save it in an image file in several formats.
 * <P>
 * Usage: java benchmarks.detinfer.pj.edu.rit.compbio.phyl.test.Test04 <I>infile</I> <I>outfile</I>
...
// Hidden operations.
	...
	private static void usage()
		{
		System.err.println ("Usage: java benchmarks.detinfer.pj.edu.rit.compbio.phyl.test.Test04 <infile> <outfile> <drawfile> [<format>]");
