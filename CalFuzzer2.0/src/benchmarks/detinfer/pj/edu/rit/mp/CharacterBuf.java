...
// Unit:    Class benchmarks.detinfer.pj.edu.rit.mp.CharacterBuf
//
...
import benchmarks.detinfer.pj.edu.rit.mp.buf.CharacterArrayBuf;
import benchmarks.detinfer.pj.edu.rit.mp.buf.CharacterArrayBuf_1;
import benchmarks.detinfer.pj.edu.rit.mp.buf.CharacterItemBuf;
import benchmarks.detinfer.pj.edu.rit.mp.buf.CharacterMatrixBuf;
import benchmarks.detinfer.pj.edu.rit.mp.buf.CharacterMatrixBuf_1;
import benchmarks.detinfer.pj.edu.rit.mp.buf.EmptyCharacterBuf;
import benchmarks.detinfer.pj.edu.rit.mp.buf.SharedCharacterBuf;
import benchmarks.detinfer.pj.edu.rit.mp.buf.SharedCharacterArrayBuf;
import benchmarks.detinfer.pj.edu.rit.mp.buf.SharedCharacterArrayBuf_1;

import benchmarks.detinfer.pj.edu.rit.pj.reduction.CharacterOp;
import benchmarks.detinfer.pj.edu.rit.pj.reduction.Op;
import benchmarks.detinfer.pj.edu.rit.pj.reduction.SharedCharacter;
import benchmarks.detinfer.pj.edu.rit.pj.reduction.SharedCharacterArray;
...
// Exported operations.
	 ...
	 * instance of class {@linkplain benchmarks.detinfer.pj.edu.rit.pj.reduction.SharedCharacter
