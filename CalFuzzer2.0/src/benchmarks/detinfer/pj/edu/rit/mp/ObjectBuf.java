...
// Unit:    Class benchmarks.detinfer.pj.edu.rit.mp.ObjectBuf<T>
//
...
import benchmarks.detinfer.pj.edu.rit.mp.buf.EmptyObjectBuf;
import benchmarks.detinfer.pj.edu.rit.mp.buf.ObjectArrayBuf;
import benchmarks.detinfer.pj.edu.rit.mp.buf.ObjectArrayBuf_1;
import benchmarks.detinfer.pj.edu.rit.mp.buf.ObjectItemBuf;
import benchmarks.detinfer.pj.edu.rit.mp.buf.ObjectMatrixBuf;
import benchmarks.detinfer.pj.edu.rit.mp.buf.ObjectMatrixBuf_1;
import benchmarks.detinfer.pj.edu.rit.mp.buf.SharedObjectBuf;
import benchmarks.detinfer.pj.edu.rit.mp.buf.SharedObjectArrayBuf;
import benchmarks.detinfer.pj.edu.rit.mp.buf.SharedObjectArrayBuf_1;

import benchmarks.detinfer.pj.edu.rit.pj.reduction.ObjectOp;
import benchmarks.detinfer.pj.edu.rit.pj.reduction.Op;
import benchmarks.detinfer.pj.edu.rit.pj.reduction.SharedObject;
import benchmarks.detinfer.pj.edu.rit.pj.reduction.SharedObjectArray;
...
// Exported operations.
	 ...
	 * instance of class {@linkplain benchmarks.detinfer.pj.edu.rit.pj.reduction.SharedObject
