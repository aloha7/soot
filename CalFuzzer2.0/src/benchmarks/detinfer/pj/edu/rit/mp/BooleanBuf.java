...
// Unit:    Class benchmarks.detinfer.pj.edu.rit.mp.BooleanBuf
//
...
import benchmarks.detinfer.pj.edu.rit.mp.buf.BooleanArrayBuf;
import benchmarks.detinfer.pj.edu.rit.mp.buf.BooleanArrayBuf_1;
import benchmarks.detinfer.pj.edu.rit.mp.buf.BooleanItemBuf;
import benchmarks.detinfer.pj.edu.rit.mp.buf.BooleanMatrixBuf;
import benchmarks.detinfer.pj.edu.rit.mp.buf.BooleanMatrixBuf_1;
import benchmarks.detinfer.pj.edu.rit.mp.buf.EmptyBooleanBuf;
import benchmarks.detinfer.pj.edu.rit.mp.buf.SharedBooleanBuf;
import benchmarks.detinfer.pj.edu.rit.mp.buf.SharedBooleanArrayBuf;
import benchmarks.detinfer.pj.edu.rit.mp.buf.SharedBooleanArrayBuf_1;

import benchmarks.detinfer.pj.edu.rit.pj.reduction.BooleanOp;
import benchmarks.detinfer.pj.edu.rit.pj.reduction.Op;
import benchmarks.detinfer.pj.edu.rit.pj.reduction.SharedBoolean;
import benchmarks.detinfer.pj.edu.rit.pj.reduction.SharedBooleanArray;
...
// Exported operations.
	 ...
	 * instance of class {@linkplain benchmarks.detinfer.pj.edu.rit.pj.reduction.SharedBoolean
