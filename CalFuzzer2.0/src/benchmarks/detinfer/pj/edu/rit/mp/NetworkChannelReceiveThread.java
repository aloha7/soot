...
// Unit:    Class benchmarks.detinfer.pj.edu.rit.mp.NetworkChannelReceiveThread
//
			...
			try
				...
				if (magic != Constants.MAGIC_NUMBER)
					...
					myChannelGroup.myLogger.log
						("benchmarks.detinfer.pj.edu.rit.mp.NetworkChannelReceiveThread: Invalid magic number received");
