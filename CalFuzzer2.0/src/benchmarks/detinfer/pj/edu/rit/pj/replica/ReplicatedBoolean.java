...
// Package: benchmarks.detinfer.pj.edu.rit.pj.replica
// Unit:    Class benchmarks.detinfer.pj.edu.rit.pj.replica.ReplicatedBoolean
//
...
import benchmarks.detinfer.pj.edu.rit.mp.BooleanBuf;
 ...
 * operator (class {@linkplain benchmarks.detinfer.pj.edu.rit.pj.reduction.Op}) to use when performing
 * updates, and specifying the communicator (class {@linkplain benchmarks.detinfer.pj.edu.rit.pj.Comm})
