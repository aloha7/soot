...
// Unit:    Class benchmarks.detinfer.pj.edu.rit.pj.LongSchedule
//
...
// Hidden operations.
	...
	private static String getSubclassName
		...
		if (name.equals ("fixed"))
			{
			return "benchmarks.detinfer.pj.edu.rit.pj.FixedLongSchedule";
			}
		else if (name.equals ("dynamic"))
			{
			return "benchmarks.detinfer.pj.edu.rit.pj.DynamicLongSchedule";
			}
		else if (name.equals ("guided"))
			{
			return "benchmarks.detinfer.pj.edu.rit.pj.GuidedLongSchedule";
			}
		else
			{
			return name;
...
//		if (args.length != 4)
//			{
//			System.err.println ("Usage: java [-Dpj.schedule=<SCHEDULE>] benchmarks.detinfer.pj.edu.rit.pj.LongSchedule <K> <lb> <ub> <stride>");
//			System.exit (1);
//			}
