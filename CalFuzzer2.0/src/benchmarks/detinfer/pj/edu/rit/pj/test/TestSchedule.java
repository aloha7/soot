...
// Unit:    Class benchmarks.detinfer.pj.edu.rit.pj.test.TestSchedule
//
 ...
 * benchmarks.detinfer.pj.edu.rit.pj.IntegerSchedule}.
 *
...
// Exported constructors.
	...
	private static int getInitialChunkSize
		...
		if (args.length != 2)
			{
			throw new IllegalArgumentException
				("TestSchedule(): Usage: -Dpj.schedule=benchmarks.detinfer.pj.edu.rit.pj.test.TestSchedule or -Dpj.schedule=\"benchmarks.determinism.pj.edu.rit.pj.test.TestSchedule(<n>,<incr>)\"");
			}
		int theInitialChunkSize;
		try
			{
