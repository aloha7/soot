...
//
// File:    Test08.java
// Package: benchmarks.detinfer.pj.edu.rit.pj.test
// Unit:    Class benchmarks.detinfer.pj.edu.rit.pj.test.Test08
//
...
import benchmarks.detinfer.pj.edu.rit.pj.IntegerStrideForLoop;
...
import benchmarks.detinfer.pj.edu.rit.pj.Schedule;

/**
 * Class Test08 is a unit test main program for classes {@linkplain
 * benchmarks.detinfer.pj.edu.rit.pj.ParallelTeam ParallelTeam}, {@linkplain benchmarks.determinism.pj.edu.rit.pj.ParallelRegion
 * ParallelRegion}, and {@linkplain benchmarks.detinfer.pj.edu.rit.pj.IntegerForLoop IntegerForLoop}.
 ...
 * benchmarks.detinfer.pj.edu.rit.pj.test.Test08 <I>lb</I> <I>ub</I> <I>stride</I>
...
// Hidden operations.
	...
	private static void usage()
		{
		System.err.println ("Usage: java [-Dpj.nt=<K>] [-Dpj.schedule=<schedule>] benchmarks.detinfer.pj.edu.rit.pj.test.Test08 <lb> <ub> <stride>");
