...
// Unit:    Class benchmarks.detinfer.pj.edu.rit.pj.cluster.test.Test04
//
 ...
 * benchmarks.detinfer.pj.edu.rit.pj.Comm}. Each process waits a random number of seconds, then prints
 * a message.
 * <P>
 * Usage: java -Dpj.np=<I>K</I> benchmarks.detinfer.pj.edu.rit.pj.cluster.test.Test04 [ <I>lb</I> [
 * <I>ub</I> ] ]
