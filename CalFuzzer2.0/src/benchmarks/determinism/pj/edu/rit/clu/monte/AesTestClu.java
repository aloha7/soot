...
// Package: benchmarks.determinism.pj.edu.rit.clu.monte
// Unit:    Class benchmarks.determinism.pj.edu.rit.clu.monte.AesTestClu
//
...
import benchmarks.determinism.pj.edu.rit.crypto.blockcipher.AES256Cipher;
...
import benchmarks.determinism.pj.edu.rit.numeric.Statistics;
...
import benchmarks.determinism.pj.edu.rit.util.Hex;
 ...
 * <P>
 * Usage: java -Dpj.np=<I>K</I> benchmarks.determinism.pj.edu.rit.clu.monte.AesTestClu <I>key</I> <I>N</I>
...
// Hidden operations.
	...
	private static void usage()
		{
		System.err.println ("Usage: java -Dpj.np=<K> benchmarks.determinism.pj.edu.rit.clu.monte.AesTestClu <key> <N>");
