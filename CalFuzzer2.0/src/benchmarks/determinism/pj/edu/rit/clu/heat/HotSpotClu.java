...
// Package: benchmarks.determinism.pj.edu.rit.clu.heat
// Unit:    Class benchmarks.determinism.pj.edu.rit.clu.heat.HotSpotClu
//
...
import benchmarks.determinism.pj.edu.rit.image.ColorImageRow;
import benchmarks.determinism.pj.edu.rit.image.PJGHueImage;
 ...
 * <P>
 * Usage: java -Dpj.np=<I>K</I> benchmarks.determinism.pj.edu.rit.clu.heat.HotSpotClu <I>imagefile</I>
...
// Hidden operations.
	...
	private static void usage()
		{
		System.err.println ("Usage: java -Dpj.np=<K> benchmarks.determinism.pj.edu.rit.clu.heat.HotSpotClu <imagefile> <H> <W> <rl1> <cl1> <ru1> <cu1> <temp1> [ <rl2> <cl2> <ru2> <cu2> <temp2> . . . ]");
