...
// Package: benchmarks.determinism.pj.edu.rit.clu.fractal
// Unit:    Class benchmarks.determinism.pj.edu.rit.clu.fractal.MandelbrotSetClu3
//
...
import benchmarks.determinism.pj.edu.rit.pj.CommRequest;
 ...
 * benchmarks.determinism.pj.edu.rit.clu.fractal.MandelbrotSetClu3 <I>width</I> <I>height</I>
...
// Hidden operations.
	...
	private static void usage()
		{
		System.err.println ("Usage: java -Dpj.np=<K> [-Dpj.schedule=<schedule>] benchmarks.determinism.pj.edu.rit.clu.fractal.MandelbrotSetClu3 <width> <height> <xcenter> <ycenter> <resolution> <maxiter> <gamma> <filename>");
