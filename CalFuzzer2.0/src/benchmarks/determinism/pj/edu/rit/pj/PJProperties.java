...
// Unit:    Class benchmarks.determinism.pj.edu.rit.pj.PJProperties
//
 ...
 * computer (see package {@linkplain benchmarks.determinism.pj.edu.rit.pj.cluster benchmarks.determinism.pj.edu.rit.pj.cluster} for
...
// Exported operations.
	 ...
	 * benchmarks.determinism.pj.edu.rit.pj.cluster benchmarks.determinism.pj.edu.rit.pj.cluster} and class {@linkplain
	 * benchmarks.determinism.pj.edu.rit.pj.cluster.JobScheduler}.
	 * <P>
	...
	public static int getPjPort()
		...
		try
			...
			int port =
				pj_port == null ?
					// benchmarks.determinism.pj.edu.rit.pj.cluster.Constants.PJ_PORT :
					20617 :
	 ...
	 * {@linkplain benchmarks.determinism.pj.edu.rit.pj.cluster benchmarks.determinism.pj.edu.rit.pj.cluster}.
	 * <P>
	 ...
	 * benchmarks.determinism.pj.edu.rit.util.Random} will construct. Specifying the <TT>"pj.prng"</TT>
	 * property will substitute a different PRNG algorithm into a program
	 * without needing to recompile. See class {@linkplain benchmarks.determinism.pj.edu.rit.util.Random}
	 * for further information.
	 * <P>
	 * If the <TT>"pj.prng"</TT> Java system property is not specified, a PRNG
	 * class name of <TT>"benchmarks.determinism.pj.edu.rit.util.DefaultRandom"</TT> is returned. See
	 * class {@linkplain benchmarks.determinism.pj.edu.rit.util.DefaultRandom} for further information.
	 *
	 * @return  Default PRNG class name.
	 */
	public static String getPjPrng()
		{
		return System.getProperty ("pj.prng", "benchmarks.determinism.pj.edu.rit.util.DefaultRandom");
		}
