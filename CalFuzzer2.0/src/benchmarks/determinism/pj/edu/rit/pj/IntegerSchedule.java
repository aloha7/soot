...
// Unit:    Class benchmarks.determinism.pj.edu.rit.pj.IntegerSchedule
//
...
// Hidden operations.
	...
	private static String getSubclassName
		...
		if (name.equals ("fixed"))
			{
			return "benchmarks.determinism.pj.edu.rit.pj.FixedIntegerSchedule";
			}
		else if (name.equals ("dynamic"))
			{
			return "benchmarks.determinism.pj.edu.rit.pj.DynamicIntegerSchedule";
			}
		else if (name.equals ("guided"))
			{
			return "benchmarks.determinism.pj.edu.rit.pj.GuidedIntegerSchedule";
			}
		else
			{
			return name;
...
//		if (args.length != 4)
//			{
//			System.err.println ("Usage: java [-Dpj.schedule=<SCHEDULE>] benchmarks.determinism.pj.edu.rit.pj.IntegerSchedule <K> <lb> <ub> <stride>");
//			System.exit (1);
//			}
