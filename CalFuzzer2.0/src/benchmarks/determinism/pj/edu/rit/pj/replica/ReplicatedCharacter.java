...
// Package: benchmarks.determinism.pj.edu.rit.pj.replica
// Unit:    Class benchmarks.determinism.pj.edu.rit.pj.replica.ReplicatedCharacter
//
...
import benchmarks.determinism.pj.edu.rit.mp.CharacterBuf;
 ...
 * operator (class {@linkplain benchmarks.determinism.pj.edu.rit.pj.reduction.Op}) to use when performing
 * updates, and specifying the communicator (class {@linkplain benchmarks.determinism.pj.edu.rit.pj.Comm})
