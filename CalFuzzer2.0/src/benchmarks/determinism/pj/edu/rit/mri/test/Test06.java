...
// Unit:    Class benchmarks.determinism.pj.edu.rit.mri.test.Test06
//
...
import benchmarks.determinism.pj.edu.rit.mri.PixelAnalysis;
...
import benchmarks.determinism.pj.edu.rit.numeric.ArraySeries;
 ...
 * benchmarks.determinism.pj.edu.rit.mri.PixelAnalysis benchmarks.determinism.pj.edu.rit.mri.PixelAnalysis}. Using an instance of
 * class {@linkplain benchmarks.determinism.pj.edu.rit.mri.SignalDataSetReader
 * benchmarks.determinism.pj.edu.rit.mri.SignalDataSetReader}, the program reads the data for a specified
 ...
 * signal.
 * <P>
 * Usage: java benchmarks.determinism.pj.edu.rit.mri.test.Test06 <I>signalfile</I> <I>R1_lower</I>
...
// Hidden operations.
	...
	private static void usage()
		{
		System.err.println ("Usage: java benchmarks.determinism.pj.edu.rit.mri.test.Test06 <signalfile> <R1_lower> <R1_upper> <N> <index>");
