...
// Package: benchmarks.determinism.pj.edu.rit.hyb.fractal
// Unit:    Class benchmarks.determinism.pj.edu.rit.hyb.fractal.MandelbrotSetHyb2
//
...
import benchmarks.determinism.pj.edu.rit.color.HSB;

import benchmarks.determinism.pj.edu.rit.image.PJGColorImage;
import benchmarks.determinism.pj.edu.rit.image.PJGImage;
...
import benchmarks.determinism.pj.edu.rit.pj.CommStatus;
import benchmarks.determinism.pj.edu.rit.pj.IntegerForLoop;
import benchmarks.determinism.pj.edu.rit.pj.IntegerSchedule;
import benchmarks.determinism.pj.edu.rit.pj.ParallelRegion;
import benchmarks.determinism.pj.edu.rit.pj.ParallelSection;
 ...
 * <TT>pj.schedule</TT> property, see class {@linkplain benchmarks.determinism.pj.edu.rit.pj.PJProperties
 * PJProperties}.
 * <P>
 ...
 * benchmarks.determinism.pj.edu.rit.pj.IntegerSchedule IntegerSchedule}.
 * <P>
 * Usage: java -Dpj.np=<I>Kp</I> -Dpj.nt=<I>Kt</I> [
 * -Dpj.schedule=<I>procschedule</I> ] benchmarks.determinism.pj.edu.rit.hyb.fractal.MandelbrotSetHyb2
...
// Hidden operations.
	...
	private static void usage()
		{
		System.err.println ("Usage: java -Dpj.np=<Kp> -Dpj.nt=<Kt> [-Dpj.schedule=<procschedule>] benchmarks.determinism.pj.edu.rit.hyb.fractal.MandelbrotSetHyb2 <width> <height> <xcenter> <ycenter> <resolution> <maxiter> <gamma> <filename> [<thrschedule>]");
