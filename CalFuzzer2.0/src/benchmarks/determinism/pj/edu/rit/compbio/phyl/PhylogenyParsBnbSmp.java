...
// Unit:    Class benchmarks.determinism.pj.edu.rit.compbio.phyl.PhylogenyParsBnbSmp
//
 ...
 * benchmarks.determinism.pj.edu.rit.compbio.phyl.PhylogenyParsBnbSmp <I>infile</I> <I>outdir</I>
 * [ <I>N</I> [ <I>T</I> ] ]
...
// Main program.
	...
	public static void main
		...
		Results.report
			(/*directory      */ outdir,
			 /*programName    */ "benchmarks.determinism.pj.edu.rit.compbio.phyl.PhylogenyParsBnbSmp",
			 /*hostName       */ "localhost",
			 /*K              */ K,
			 /*infile         */ infile,
	...
	private static void usage()
		{
		System.err.println ("Usage: java [-Dpj.nt=<Kt>] [-Dpj.schedule=<schedule>] benchmarks.determinism.pj.edu.rit.compbio.phyl.PhylogenyParsBnbSmp <infile> <outdir> [<N> [<T>]]");
