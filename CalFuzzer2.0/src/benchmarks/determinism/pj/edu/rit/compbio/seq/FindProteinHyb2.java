...
// Package: benchmarks.determinism.pj.edu.rit.compbio.seq
// Unit:    Class benchmarks.determinism.pj.edu.rit.compbio.seq.FindProteinHyb2
//
...
import benchmarks.determinism.pj.edu.rit.pj.LongForLoop;
import benchmarks.determinism.pj.edu.rit.pj.LongSchedule;
...
import benchmarks.determinism.pj.edu.rit.util.LongRange;
 ...
 * -Dpj.schedule=<I>procschedule</I> ] benchmarks.determinism.pj.edu.rit.compbio.seq.FindProteinHyb2
...
// Hidden operations.
	...
	private static void usage()
		{
		System.err.println ("Usage: java -Dpj.np=<Kp> -Dpj.nt=<Kt> [-Dpj.schedule=<procschedule>] benchmarks.determinism.pj.edu.rit.compbio.seq.FindProteinHyb2 <queryfile> <databasefile> <indexfile> [<thrschedule> [<expect>]]");
