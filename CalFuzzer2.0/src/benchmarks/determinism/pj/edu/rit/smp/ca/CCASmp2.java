...
//
// File:    CCASmp2.java
// Package: benchmarks.determinism.pj.edu.rit.smp.ca
// Unit:    Class benchmarks.determinism.pj.edu.rit.smp.ca.CCASmp2
//
...
import benchmarks.determinism.pj.edu.rit.image.GrayImageRow;
import benchmarks.determinism.pj.edu.rit.image.PJGGrayImage;
 ...
 * <P>
 * Usage: java [ -Dpj.nt=<I>K</I> ] benchmarks.determinism.pj.edu.rit.smp.ca.CCASmp2 <I>C</I> <I>S</I>
 ...
 * about the PJG format, see class {@linkplain benchmarks.determinism.pj.edu.rit.image.PJGImage}.
 *
...
// Hidden operations.
	...
	private static void usage()
		{
		System.err.println ("Usage: java [-Dpj.nt=<K>] benchmarks.determinism.pj.edu.rit.smp.ca.CCASmp2 <C> <S> <A> <B> <imagefile>");
