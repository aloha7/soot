...
// Package: benchmarks.determinism.pj.edu.rit.smp.fractal
// Unit:    Class benchmarks.determinism.pj.edu.rit.smp.fractal.MandelbrotSetSmp3
//
...
import benchmarks.determinism.pj.edu.rit.pj.BarrierAction;
 ...
 * benchmarks.determinism.pj.edu.rit.smp.fractal.MandelbrotSetSmp3 <I>width</I> <I>height</I>
...
// Hidden operations.
	...
	private static void usage()
		{
		System.err.println ("Usage: java -Dpj.nt=<K> -Dpj.schedule=<schedule> benchmarks.determinism.pj.edu.rit.smp.fractal.MandelbrotSetSmp3 <width> <height> <xcenter> <ycenter> <resolution> <maxiter> <gamma> <filename>");
