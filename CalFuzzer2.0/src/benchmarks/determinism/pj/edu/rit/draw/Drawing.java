...
//
// File:    Drawing.java
// Package: benchmarks.determinism.pj.edu.rit.draw
// Unit:    Class benchmarks.determinism.pj.edu.rit.draw.Drawing
//
...
import benchmarks.determinism.pj.edu.rit.draw.item.ColorFill;
import benchmarks.determinism.pj.edu.rit.draw.item.DrawingItem;
import benchmarks.determinism.pj.edu.rit.draw.item.Group;
import benchmarks.determinism.pj.edu.rit.draw.item.Point;
import benchmarks.determinism.pj.edu.rit.draw.item.Size;
...
// Exported operations.
	...
	/**
	 * Returns a {@linkplain benchmarks.determinism.pj.edu.rit.draw.item.Group Group} consisting of the
