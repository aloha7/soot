...
// Unit:    Class benchmarks.determinism.pj.edu.rit.mp.ShortBuf
//
...
import benchmarks.determinism.pj.edu.rit.mp.buf.EmptyShortBuf;
import benchmarks.determinism.pj.edu.rit.mp.buf.ShortArrayBuf;
import benchmarks.determinism.pj.edu.rit.mp.buf.ShortArrayBuf_1;
import benchmarks.determinism.pj.edu.rit.mp.buf.ShortItemBuf;
import benchmarks.determinism.pj.edu.rit.mp.buf.ShortMatrixBuf;
import benchmarks.determinism.pj.edu.rit.mp.buf.ShortMatrixBuf_1;
import benchmarks.determinism.pj.edu.rit.mp.buf.SharedShortBuf;
import benchmarks.determinism.pj.edu.rit.mp.buf.SharedShortArrayBuf;
import benchmarks.determinism.pj.edu.rit.mp.buf.SharedShortArrayBuf_1;

import benchmarks.determinism.pj.edu.rit.pj.reduction.ShortOp;
import benchmarks.determinism.pj.edu.rit.pj.reduction.Op;
import benchmarks.determinism.pj.edu.rit.pj.reduction.SharedShort;
import benchmarks.determinism.pj.edu.rit.pj.reduction.SharedShortArray;
...
// Exported operations.
	 ...
	 * instance of class {@linkplain benchmarks.determinism.pj.edu.rit.pj.reduction.SharedShort
