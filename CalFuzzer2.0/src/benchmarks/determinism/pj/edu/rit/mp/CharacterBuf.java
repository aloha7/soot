...
// Unit:    Class benchmarks.determinism.pj.edu.rit.mp.CharacterBuf
//
...
import benchmarks.determinism.pj.edu.rit.mp.buf.CharacterArrayBuf;
import benchmarks.determinism.pj.edu.rit.mp.buf.CharacterArrayBuf_1;
import benchmarks.determinism.pj.edu.rit.mp.buf.CharacterItemBuf;
import benchmarks.determinism.pj.edu.rit.mp.buf.CharacterMatrixBuf;
import benchmarks.determinism.pj.edu.rit.mp.buf.CharacterMatrixBuf_1;
import benchmarks.determinism.pj.edu.rit.mp.buf.EmptyCharacterBuf;
import benchmarks.determinism.pj.edu.rit.mp.buf.SharedCharacterBuf;
import benchmarks.determinism.pj.edu.rit.mp.buf.SharedCharacterArrayBuf;
import benchmarks.determinism.pj.edu.rit.mp.buf.SharedCharacterArrayBuf_1;

import benchmarks.determinism.pj.edu.rit.pj.reduction.CharacterOp;
import benchmarks.determinism.pj.edu.rit.pj.reduction.Op;
import benchmarks.determinism.pj.edu.rit.pj.reduction.SharedCharacter;
import benchmarks.determinism.pj.edu.rit.pj.reduction.SharedCharacterArray;
...
// Exported operations.
	 ...
	 * instance of class {@linkplain benchmarks.determinism.pj.edu.rit.pj.reduction.SharedCharacter
