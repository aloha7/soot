...
// Unit:    Class benchmarks.determinism.pj.edu.rit.mp.BooleanBuf
//
...
import benchmarks.determinism.pj.edu.rit.mp.buf.BooleanArrayBuf;
import benchmarks.determinism.pj.edu.rit.mp.buf.BooleanArrayBuf_1;
import benchmarks.determinism.pj.edu.rit.mp.buf.BooleanItemBuf;
import benchmarks.determinism.pj.edu.rit.mp.buf.BooleanMatrixBuf;
import benchmarks.determinism.pj.edu.rit.mp.buf.BooleanMatrixBuf_1;
import benchmarks.determinism.pj.edu.rit.mp.buf.EmptyBooleanBuf;
import benchmarks.determinism.pj.edu.rit.mp.buf.SharedBooleanBuf;
import benchmarks.determinism.pj.edu.rit.mp.buf.SharedBooleanArrayBuf;
import benchmarks.determinism.pj.edu.rit.mp.buf.SharedBooleanArrayBuf_1;

import benchmarks.determinism.pj.edu.rit.pj.reduction.BooleanOp;
import benchmarks.determinism.pj.edu.rit.pj.reduction.Op;
import benchmarks.determinism.pj.edu.rit.pj.reduction.SharedBoolean;
import benchmarks.determinism.pj.edu.rit.pj.reduction.SharedBooleanArray;
...
// Exported operations.
	 ...
	 * instance of class {@linkplain benchmarks.determinism.pj.edu.rit.pj.reduction.SharedBoolean
