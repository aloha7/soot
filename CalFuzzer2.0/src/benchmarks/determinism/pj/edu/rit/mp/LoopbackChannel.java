...
// Unit:    Class benchmarks.determinism.pj.edu.rit.mp.LoopbackChannel
//
		...
		synchronized (this)
			...
			if (myWriteState == WRITE_CLOSED)
				...
				throw new IOException
					("benchmarks.determinism.pj.edu.rit.mp.LoopbackChannel: Channel closed");
				}
			}
		...
		try
			...
			IOException exc2 =
				new InterruptedIOException
					("benchmarks.determinism.pj.edu.rit.mp.LoopbackChannel: Send interrupted");
			exc2.initCause (exc);
			throw exc2;
			}
