...
// Unit:    Class benchmarks.determinism.pj.edu.rit.mp.DoubleBuf
//
...
import benchmarks.determinism.pj.edu.rit.mp.buf.DoubleArrayBuf;
import benchmarks.determinism.pj.edu.rit.mp.buf.DoubleArrayBuf_1;
import benchmarks.determinism.pj.edu.rit.mp.buf.DoubleItemBuf;
import benchmarks.determinism.pj.edu.rit.mp.buf.DoubleMatrixBuf;
import benchmarks.determinism.pj.edu.rit.mp.buf.DoubleMatrixBuf_1;
import benchmarks.determinism.pj.edu.rit.mp.buf.EmptyDoubleBuf;
import benchmarks.determinism.pj.edu.rit.mp.buf.SharedDoubleBuf;
import benchmarks.determinism.pj.edu.rit.mp.buf.SharedDoubleArrayBuf;
import benchmarks.determinism.pj.edu.rit.mp.buf.SharedDoubleArrayBuf_1;

import benchmarks.determinism.pj.edu.rit.pj.reduction.DoubleOp;
import benchmarks.determinism.pj.edu.rit.pj.reduction.Op;
import benchmarks.determinism.pj.edu.rit.pj.reduction.SharedDouble;
import benchmarks.determinism.pj.edu.rit.pj.reduction.SharedDoubleArray;
...
// Exported operations.
	 ...
	 * instance of class {@linkplain benchmarks.determinism.pj.edu.rit.pj.reduction.SharedDouble
