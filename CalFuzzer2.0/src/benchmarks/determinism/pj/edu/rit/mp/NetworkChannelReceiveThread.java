...
// Unit:    Class benchmarks.determinism.pj.edu.rit.mp.NetworkChannelReceiveThread
//
			...
			try
				...
				if (magic != Constants.MAGIC_NUMBER)
					...
					myChannelGroup.myLogger.log
						("benchmarks.determinism.pj.edu.rit.mp.NetworkChannelReceiveThread: Invalid magic number received");
