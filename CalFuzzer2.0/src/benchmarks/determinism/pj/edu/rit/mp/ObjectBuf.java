...
// Unit:    Class benchmarks.determinism.pj.edu.rit.mp.ObjectBuf<T>
//
...
import benchmarks.determinism.pj.edu.rit.mp.buf.EmptyObjectBuf;
import benchmarks.determinism.pj.edu.rit.mp.buf.ObjectArrayBuf;
import benchmarks.determinism.pj.edu.rit.mp.buf.ObjectArrayBuf_1;
import benchmarks.determinism.pj.edu.rit.mp.buf.ObjectItemBuf;
import benchmarks.determinism.pj.edu.rit.mp.buf.ObjectMatrixBuf;
import benchmarks.determinism.pj.edu.rit.mp.buf.ObjectMatrixBuf_1;
import benchmarks.determinism.pj.edu.rit.mp.buf.SharedObjectBuf;
import benchmarks.determinism.pj.edu.rit.mp.buf.SharedObjectArrayBuf;
import benchmarks.determinism.pj.edu.rit.mp.buf.SharedObjectArrayBuf_1;

import benchmarks.determinism.pj.edu.rit.pj.reduction.ObjectOp;
import benchmarks.determinism.pj.edu.rit.pj.reduction.Op;
import benchmarks.determinism.pj.edu.rit.pj.reduction.SharedObject;
import benchmarks.determinism.pj.edu.rit.pj.reduction.SharedObjectArray;
...
// Exported operations.
	 ...
	 * instance of class {@linkplain benchmarks.determinism.pj.edu.rit.pj.reduction.SharedObject
