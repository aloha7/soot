...
// Unit:    Class benchmarks.determinism.pj.edu.rit.mp.LongBuf
//
...
import benchmarks.determinism.pj.edu.rit.mp.buf.EmptyLongBuf;
import benchmarks.determinism.pj.edu.rit.mp.buf.LongArrayBuf;
import benchmarks.determinism.pj.edu.rit.mp.buf.LongArrayBuf_1;
import benchmarks.determinism.pj.edu.rit.mp.buf.LongItemBuf;
import benchmarks.determinism.pj.edu.rit.mp.buf.LongMatrixBuf;
import benchmarks.determinism.pj.edu.rit.mp.buf.LongMatrixBuf_1;
import benchmarks.determinism.pj.edu.rit.mp.buf.SharedLongBuf;
import benchmarks.determinism.pj.edu.rit.mp.buf.SharedLongArrayBuf;
import benchmarks.determinism.pj.edu.rit.mp.buf.SharedLongArrayBuf_1;

import benchmarks.determinism.pj.edu.rit.pj.reduction.LongOp;
import benchmarks.determinism.pj.edu.rit.pj.reduction.Op;
import benchmarks.determinism.pj.edu.rit.pj.reduction.SharedLong;
import benchmarks.determinism.pj.edu.rit.pj.reduction.SharedLongArray;
...
// Exported operations.
	 ...
	 * instance of class {@linkplain benchmarks.determinism.pj.edu.rit.pj.reduction.SharedLong
