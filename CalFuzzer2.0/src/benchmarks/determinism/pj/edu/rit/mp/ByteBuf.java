...
// Unit:    Class benchmarks.determinism.pj.edu.rit.mp.ByteBuf
//
...
import benchmarks.determinism.pj.edu.rit.mp.buf.ByteArrayBuf;
import benchmarks.determinism.pj.edu.rit.mp.buf.ByteArrayBuf_1;
import benchmarks.determinism.pj.edu.rit.mp.buf.ByteItemBuf;
import benchmarks.determinism.pj.edu.rit.mp.buf.ByteMatrixBuf;
import benchmarks.determinism.pj.edu.rit.mp.buf.ByteMatrixBuf_1;
import benchmarks.determinism.pj.edu.rit.mp.buf.EmptyByteBuf;
import benchmarks.determinism.pj.edu.rit.mp.buf.SharedByteBuf;
import benchmarks.determinism.pj.edu.rit.mp.buf.SharedByteArrayBuf;
import benchmarks.determinism.pj.edu.rit.mp.buf.SharedByteArrayBuf_1;

import benchmarks.determinism.pj.edu.rit.pj.reduction.ByteOp;
import benchmarks.determinism.pj.edu.rit.pj.reduction.Op;
import benchmarks.determinism.pj.edu.rit.pj.reduction.SharedByte;
import benchmarks.determinism.pj.edu.rit.pj.reduction.SharedByteArray;
...
// Exported operations.
	 ...
	 * instance of class {@linkplain benchmarks.determinism.pj.edu.rit.pj.reduction.SharedByte
