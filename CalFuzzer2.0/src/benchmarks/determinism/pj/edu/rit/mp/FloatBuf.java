...
// Unit:    Class benchmarks.determinism.pj.edu.rit.mp.FloatBuf
//
...
import benchmarks.determinism.pj.edu.rit.mp.buf.EmptyFloatBuf;
import benchmarks.determinism.pj.edu.rit.mp.buf.FloatArrayBuf;
import benchmarks.determinism.pj.edu.rit.mp.buf.FloatArrayBuf_1;
import benchmarks.determinism.pj.edu.rit.mp.buf.FloatItemBuf;
import benchmarks.determinism.pj.edu.rit.mp.buf.FloatMatrixBuf;
import benchmarks.determinism.pj.edu.rit.mp.buf.FloatMatrixBuf_1;
import benchmarks.determinism.pj.edu.rit.mp.buf.SharedFloatBuf;
import benchmarks.determinism.pj.edu.rit.mp.buf.SharedFloatArrayBuf;
import benchmarks.determinism.pj.edu.rit.mp.buf.SharedFloatArrayBuf_1;

import benchmarks.determinism.pj.edu.rit.pj.reduction.FloatOp;
import benchmarks.determinism.pj.edu.rit.pj.reduction.Op;
import benchmarks.determinism.pj.edu.rit.pj.reduction.SharedFloat;
import benchmarks.determinism.pj.edu.rit.pj.reduction.SharedFloatArray;
...
// Exported operations.
	 ...
	 * instance of class {@linkplain benchmarks.determinism.pj.edu.rit.pj.reduction.SharedFloat
